...
final List<Pair> jsonUnicodeTests =
  ...
  inQuotesBytes.add($quote);
  expanded.add(Pair(inQuotesBytes, testValue.target));
  ...
  expanded.add(Pair(inListBytes, listExpected));
  ...
  expanded.add(Pair(listLongerBytes, listLongerExpected));
  ...
  mapBytes.add($rbrace);
  expanded.add(Pair(mapBytes, mapExpected));
